...
export function getSiteMetadata(lang: Language) {
  const isPolish = lang === "pl";

  return {
    title: {
      default: isPolish
        ? "WooCommerce Access Passes - Zarządzanie Dostępem Czasowym"
        : "WooCommerce Access Passes - Time-Based Access Management",
      template: "%s | Access Passes",
    },
    description: isPolish
      ? "Sumowalny dostęp czasowy dla WooCommerce. Proste zakupy, które przyznają czas. Idealne dla kursów, członkostw i produktów cyfrowych."
...
export const SITE_METADATA = getSiteMetadata("en");
